...
<html lang="en">
  <head>
    ...
    <title>Programa Geosaude - Noticias</title>
    <link href="bootstrap-3.3.6-dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="bootstrap-3.3.6-dist/css/bootstrap-theme.min.css" rel="stylesheet">
    <link href="css/noticiascss.css" rel="stylesheet">
  ...
  <body>
    ...
    <div class="row featurette">
      <div class="col-md-4">
      <img class="center-block" src="<?= $noticia->imagem ?>" alt="Imagem" width="370" height="200">
      </div>
      <div class="col-md-8">
       <h3 class="featurette-heading"><?= $noticia->titulo ?></h2>
        <p><?= $noticia->resumo ?></p><a href="noticia.php?visualizar=<?= $noticia->id ?>">Continue lendo</a>
      </div>
    </div>
    <?php endwhile ?>
    <hr class="featurette-divider">
