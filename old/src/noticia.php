...
<html lang="en">
  <head>
    ...
    <link href="css/noticiacss.css" rel="stylesheet">
  ...
  <body>
    ...
    <div>
      <h1 class="page-header text-center"><?= $noticia->titulo ?></h1>
      <p class="lead text-center"><?= $noticia->autor ?>, <?= $noticia->data ?></p>
    </div>

    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <img class="center-block" src="<?= $noticia->imagem ?>" alt="Imagem" width="570" height="300">
      </div>
    </div>
    <br>
    <div class="row">
