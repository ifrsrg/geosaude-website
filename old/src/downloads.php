<?php
require_once("restrita/persistencia/downloadDAO.php");
$dao = new DownloadDAO();
$downloads = null;

if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    $downloadsNovos = $dao->selecionaNovos();
...
<html lang="en">
  <head>
    ...
    <link href="css/downloadscss.css" rel="stylesheet">
  ...
  <body>
    ...
    <php while($download = $downloads->fetch()): ?>
      <div class="col-md-4">
        <h2><?= $download->titulo ?></h2>
        <p><?= $download->descricao ?></p>
        <p><a class="btn btn-default" href="#" role="button">Download</a></p>
      </div>
    <?php endwhile ?>
    </div>
