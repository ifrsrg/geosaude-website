			...
			<div class="wrapper">
				...
				<div id="creditos" class="corBorda">
					<div id="creditos_content">
						...
						<div id="equipe">Tema adaptado da <a href="http://wp.ufpel.edu.br/sobre/tema-ufpel-2016" target="_blank">UFPel 2016</a> desenvolvido por <a href="http://wp.ufpel.edu.br/equipe" target="_blank">Equipe WP IFRS</a>.</div>
					</div>
				</div>
			</div>
		</footer>
